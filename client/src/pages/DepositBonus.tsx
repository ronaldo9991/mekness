...
import { 
  ...
  Clock, Users, Zap, Shield, AlertCircle
} from "lucide-react";
...
export default function DepositBonus() {
  ...
  const howToClaim = [
    {
      step: "1",
      title: "Open Account",
      description: "Register for a new trading account with Mekness or log into existing account.",
      icon: Users
    },
    {
      step: "2",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <div className="relative min-h-[75vh] flex items-center overflow-hidden pt-36 sm:pt-48 pb-20">
          ...
          >
            <div className="inline-block mb-10">
              <div className="px-6 py-2.5 bg-primary/10 border border-primary/30 rounded-full backdrop-blur-sm neon-gold animate-pulse-glow">
                <span className="text-primary font-semibold">🎁 Limited Time Offer • Up to 50% Bonus</span>
              </div>
            </div>
