        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
              Mekness <span className="text-gradient-gold text-glow-gold">Complaints</span>
            </h1>
            ...
            {[
              {
                ...
                description: "complains@mekness.com",
              },
              {
                icon: AlertCircle,
                title: "Report Abuse",
                description: "abuse@mekness.com",
              },
              {
                icon: Clock,
                title: "Response Time",
              ...
              <div className="glass-morphism-strong border border-primary/20 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
                  <p>
                    ...
                    <a href="mailto:complains@mekness.com" className="text-primary hover:underline font-medium ml-1">
                      complains@mekness.com
                    </a>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:complains@mekness.com"
            ...
            >
              <Card className="glass-morphism-strong border border-primary/20 rounded-3xl p-8 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full neon-gold magnetic-hover">
                    Submit Complaint
                  </Button>
                </form>
              </Card>
