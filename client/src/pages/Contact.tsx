        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
              Contact <span className="text-gradient-gold text-glow-gold">Mekness</span>
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-16">
            {[
              ...
              },
              {
                icon: Mail,
                title: "Email Us",
                description: "support@mekness.com",
              },
              {
                icon: Clock,
                title: "Response Time",
                ...
                <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
                  ...
                  <div className="flex items-start gap-4 pt-2">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">24/7 • Around the Clock</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Button type="submit" className="w-full neon-gold magnetic-hover" data-testid="button-submit">
                  Send Message
                </Button>
              </form>
            </Card>
          ...
          >
            <details className="glass-morphism-strong border border-primary/20 rounded-3xl p-6 shadow-2xl group" open={false}>
              ...
              <div className="mt-6 space-y-6 text-sm leading-relaxed text-muted-foreground max-h-[50vh] overflow-y-auto pr-4">
                <section>
                  <p>Mekness Brokerage Inc. (will be mention as Mekness in the following) takes your privacy seriously. The main purpose of this Privacy Policy is to inform you of how we treat your personal information that Mekness collects and receives when you use Mekness’s customer's portals, intended customer applications, job applications, website visitors. This policy is based on the privacy and data protection principles common to the countries in which we operate.</p>
                </section>
                <section>
                  <h5 className="text-foreground font-semibold mb-2">Are you required to provide Personal Information?</h5>
                  <p>For you to utilize our services, you will provide us with your Personal Information entirely spontaneously. In most circumstances, Mekness cannot take action without utilizing certain of your Personal Information, for example, because this Personal Information is required to process your instructions or orders or provide you with access to our services or marketing materials. In most cases, it will be impossible for us to provide the services to you without the relevant Personal Information.</p>
                </section>
                <section>
                  <h5 className="text-foreground font-semibold mb-2">Information Mekness Collects and Uses</h5>
                  <p>Personal information is information about you such as your name, address, email address, or phone number, and that is not otherwise publicly available. For some financial products and services, we might also request your address, Social Security number, and information about your assets. Mekness depends on our users to update and correct their personal information when necessary.</p>
                ...
                <section>
                  ...
                  <p>Mekness uses physical, electronic, and procedural safeguards and technologies to protect personal information from unauthorized access, use, or disclosure. Mekness limits access to your personal information to our employees, contractors, and agents who we believe reasonably need to gain access to such information to do their jobs to operate, implement, develop, perform or improve our services. These individuals are bound by confidentiality obligations to Mekness and may be subject to termination or legal actions if they fail to comply with these obligations.</p>
                </section>
                <section>
                  <h5 className="text-foreground font-semibold mb-2">Retention of Communications</h5>
                  <p>When you send an email or other communications to Mekness, we retain those communications for a certain period to process your questions and concerns, respond to your requests, and improve our services.</p>
                </section>
                <section>
                ...
                <section>
                  ...
                  <p>Concerning EEA residents and where your Personal Information is processed by a Mekness Entity established in the EEA (“Covered Individuals”). If you are a Covered Individual you have several legal rights under GDPR concerning the Personal Information that we hold about you. You can request these pieces of information by sending us an info request: info@mekness.com</p>
                </section>
                <section>
                  <h5 className="text-foreground font-semibold mb-2">Our Policy</h5>
                  <p>Mekness regularly review our Privacy Policy. We will update this Privacy Policy from time to time, with or without notice. Mekness will, however, notify you about significant changes by sending a notice to your primary email address or by placing a notice on our website. Please feel free to contact us if you have questions or suggestions regarding this Privacy Policy by contacting us through the website.</p>
                </section>
                <section>
                  <h5 className="text-foreground font-semibold mb-2">How to contact us</h5>
                  <p>We welcome your views about our website and our Privacy Policy. If you have any questions about this Policy, please contact the Data Protection Officer at info@mekness.com or please contact Mekness Customer Services through the Mekness website at https://www.mekness.com/contact-us.</p>
                </section>
              </div>
            </details>
          </motion.div>
