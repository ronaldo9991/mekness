...
import { Loader2, ArrowRight, Wallet, History, AlertCircle } from "lucide-react";
        ...
        >
          <Card className="p-6 border-primary/30 bg-gradient-to-br from-black/80 to-primary/10 backdrop-blur-xl">
            ...
            <form onSubmit={handleTransfer} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-primary via-primary/95 to-primary hover:from-primary/90 hover:via-primary/85 hover:to-primary/90 text-black font-bold shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all"
