...
export default function CorporateServices() {
  const services = [
    {
      ...
      description: "Mekness IB's revenue sharing model will help your business grow beyond benchmark. Earn competitive commissions and enjoy dedicated support.",
      features: [
    ...
    },
    {
      ...
      description: "Our Mekness team will analyse your customer and business structure to setup the most rewarding and efficient solution for your needs.",
      features: [
        "Custom Integration",
  ...
  return (
    <div className="py-24 px-4 relative overflow-hidden bg-gradient-to-b from-background via-accent/20 to-background">
      {/* Background effects */}
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-4">
            <span className="text-primary">Partner With</span> Mekness
          </h2>
            ...
            >
              <Card className={`p-8 glass-morphism-strong card-hover-3d h-full group relative overflow-hidden border-2 border-primary/20 hover:border-primary/60 transition-all duration-500`}>
                ...
                <div className="relative z-10">
                  ...
                  {/* CTA */}
                  <Link href="/contact">
                    <Button className="w-full magnetic-hover neon-border-animate group" variant="outline">
                      More Information
