  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Static spheres - GPU accelerated */}
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="absolute w-24 h-24 rounded-full border-2 border-primary/40 transition-transform duration-300"
            style={{
              left: "50%",
              top: "50%",
              marginLeft: "-48px",
              marginTop: "-48px",
              transform: `translate3d(0, 0, 0) rotate(${i * 120}deg) translateX(80px) rotate(-${i * 120}deg)`,
        ...
        {isHovered && (
          <>
            ...
            {[...Array(3)].map((_, i) => (
              <div
                key={`animated-${i}`}
                className="absolute w-24 h-24 rounded-full border-2 border-primary/50 animate-orbit"
                style={{
                  left: "50%",
                  top: "50%",
                  marginLeft: "-48px",
