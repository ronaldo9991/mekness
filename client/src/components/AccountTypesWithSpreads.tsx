        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4 mb-16 md:mb-24 lg:mb-32">
          {accountTypes.map((account, index) => (
            ...
            >
              ...
              <Card className={`p-8 glass-morphism card-hover-3d h-full group transition-all duration-500 ${
                ...
                <Link href="/signup">
                  <Button className={`w-full magnetic-hover ${account.popular ? "neon-gold" : "neon-border-animate"}`} variant={account.popular ? "default" : "outline"}>
                    Open Account
                  </Button>
                </Link>
              </Card>
