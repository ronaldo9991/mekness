...
const mainNavItems = [
  ...
  { title: "Accounts", icon: Wallet, url: "/dashboard/accounts" },
...
export default function DashboardSidebar() {
        ...
        <TooltipTrigger asChild>
          <motion.a
            ...
            className={cn(
              ...
              "transition-all duration-300 group/item min-w-[70px]",
          ...
          >
            ...
            >
              ...
              >
                <item.icon className={cn(
                  ...
                  isActive && "drop-shadow-[0_0_12px_rgba(212,175,55,0.8)]",
                  "group-hover/item:drop-shadow-[0_0_8px_rgba(212,175,55,0.5)]"
                )} />
              </motion.div>
              
              {/* Pulsing glow ring - always active */}
              <motion.div
              ...
              {/* Active enhanced glow ring */}
              {isActive && (
                <>
                  <motion.div
                    className="absolute inset-0 bg-primary/50 rounded-full blur-lg -z-10"
                    ...
                    <motion.div
                      ...
                      animate={{
                        x: [
                          ...
                          Math.cos(i * (Math.PI * 2 / 3) + Math.PI) * 12,
                          Math.cos(i * (Math.PI * 2 / 3)) * 12,
                        ],
                        y: [
                          Math.sin(i * (Math.PI * 2 / 3)) * 12,
                          Math.sin(i * (Math.PI * 2 / 3) + Math.PI) * 12,
                          Math.sin(i * (Math.PI * 2 / 3)) * 12,
                        ],
                        opacity: [0.4, 1, 0.4],
                      }}
              ...
              {/* Hover pulse effect */}
              <motion.div
                className="absolute inset-0 bg-primary/20 rounded-full blur-sm opacity-0 group-hover/item:opacity-100 -z-10"
                animate={isActive ? {} : {
                  scale: [1, 1.2, 1],
                }}
                transition={{
            ...
            {/* Active bottom indicator with pulse */}
            {isActive && (
              <motion.div
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-b from-primary/0 via-primary/10 to-primary/0 opacity-0 group-hover/item:opacity-100 rounded-lg"
              initial={false}
            />
  ...
  return (
    <nav className="relative w-full border-b border-primary/20 bg-gradient-to-b from-sidebar via-sidebar/98 to-sidebar z-50 overflow-hidden">
      ...
      <div className="relative max-w-[1920px] mx-auto px-2 sm:px-4">
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          >
            <div className="relative group">
              ...
              <motion.div
                className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-green-500 rounded-full border-2 border-sidebar z-10"
                animate={{
                  scale: [1, 1.4, 1],
                  opacity: [1, 0.7, 1],
                }}
