...
const companyLinks = [
  ...
  { label: "Downloads", href: "https://mekness.com/downloads", external: true },
];
...
const forexLinks = [
  ...
  { label: "Forexpedia", href: "/forex#forexpedia" },
...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-primary/20 bg-gradient-to-b from-background to-black py-20 px-6 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-[1.3fr_1fr] items-start">
          <div className="glass-morphism-strong border border-primary/25 rounded-3xl p-8 backdrop-blur-xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-xs text-muted-foreground leading-relaxed">
              <div className="space-y-3">
                <p>
                  This website is operated by <span className="text-primary font-medium">Mekness Limited</span> Registration No:
              ...
              <div className="space-y-3">
                ...
                <p>
                  <span className="font-medium text-foreground">Restricted Regions:</span> Mekness does not offer services to residents of jurisdictions including USA, Canada, Japan, Iran, Labuan Malaysia, Cuba, Sudan, Syria, and North Korea.
                </p>
              </div>
            </div>
          ...
          <div className="glass-morphism border border-primary/20 rounded-3xl p-8 space-y-6">
            ...
            <div className="space-y-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:support@mekness.com" className="text-foreground font-medium hover:text-primary transition-colors">
                  support@mekness.com
                </a>
              </div>
              <div className="flex items-start gap-3">
        ...
        <div className="mt-16 border-t border-primary/20 pt-6 text-center text-xs text-muted-foreground space-y-2">
          <p className="text-primary font-semibold tracking-[0.4em] uppercase">© 2025 Mekness Limited. All Rights Reserved.</p>
